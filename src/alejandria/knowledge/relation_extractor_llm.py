...
VALID_RELATION_TYPES = {
    ...
    "HAS_TITLE", "TRIBE_OF",
    # Prophetic / Doctrinal
    "PROPHESIED_ABOUT", "TAUGHT", "PROPHESIED_TO",
    # Geographic
    ...
    "FOUGHT_AGAINST", "ALLIED_WITH", "COMMANDED_BY", "SERVED_UNDER",
    # Spiritual
    "BAPTIZED_BY", "ORDAINED_BY", "BLESSED_BY", "HEALED_BY",
    "CONVERTED_BY", "APPEARED_TO",
}
...
- Prophetic: PROPHESIED_ABOUT, TAUGHT, PROPHESIED_TO
- Geographic: TRAVELED_TO, LIVED_IN, BORN_IN, DIED_IN, FOUNDED
- Temporal: LIVED_DURING, WRITTEN_DURING
- Authorship: AUTHORED
- Interaction: FOUGHT_AGAINST, ALLIED_WITH, COMMANDED_BY, SERVED_UNDER
- Spiritual: BAPTIZED_BY, ORDAINED_BY, BLESSED_BY, HEALED_BY, CONVERTED_BY, APPEARED_TO"""
