---
title: "Pregunta vs. reprensión directa — los dos registros de la comunicación divina"
date: 2026-04-15
status: draft
type: contraste
seed_entity: ""
related_forms: []
tags: [pedagogia, preguntas, represion, registros, metodo-del-salvador]
---
...
```mermaid
graph TD
    COND["Condición del<br/>interlocutor"]
    
    IGN["Ignorancia genuina<br/>Gn 3, Alma 18"]
    FEI["Fe imperfecta<br/>Mc 9, Gn 18"]
    DOL["Dolor legítimo<br/>1 Re 19, DyC 121"]
    ART["Necesidad de articular<br/>Mt 16, Jn 21"]
    
    HIP["Hipocresía deliberada<br/>Mt 23"]
    PRO["Profanación de lo sagrado<br/>Mt 21"]
    RES["Resistencia activa<br/>Mt 16:23"]
    DES["Desobediencia explícita<br/>DyC 3, 93, 95"]
    
    PREG["PREGUNTA<br/>pedagógica"]
    REPR["REPRENSIÓN<br/>directa"]
    ...
    style PREG fill:#d0e4f7,color:#1a1a1a
    style REPR fill:#f5d0d0,color:#1a1a1a
    style COND fill:#f5ecd0,color:#1a1a1a
```
